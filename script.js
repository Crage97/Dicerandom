...
const sexPositions = [
    ...
    { name: "Missionary", description: "Classic face-to-face position with intimate eye contact. One partner lies on their back while the other lies on top.", image: "https://images.pexels.com/photos/6899789/pexels-photo-6899789.jpeg" },
    { name: "Doggy Style", description: "Rear-entry position where one partner bends over while the other enters from behind, allowing for deep penetration.", image: "https://images.pexels.com/photos/16251532/pexels-photo-16251532.jpeg" },
    { name: "Cowgirl", description: "Woman on top position where the receiving partner straddles and controls the rhythm and depth.", image: "https://images.pexels.com/photos/5851702/pexels-photo-5851702.jpeg" },
    { name: "Reverse Cowgirl", description: "Woman on top but facing away, allowing for different sensations and visual appeal.", image: "https://images.pexels.com/photos/12675574/pexels-photo-12675574.jpeg" },
    { name: "Spooning", description: "Side-by-side position where partners lie like spoons, intimate and comfortable for extended sessions.", image: "https://images.pexels.com/photos/6899789/pexels-photo-6899789.jpeg" },
    { name: "Standing", description: "Upright position that can be done against a wall or free-standing for adventurous couples.", image: "https://images.pexels.com/photos/16251532/pexels-photo-16251532.jpeg" },
    { name: "The Lotus", description: "Sitting position where partners face each other with legs wrapped around, perfect for intimacy and connection.", image: "https://images.pexels.com/photos/5851702/pexels-photo-5851702.jpeg" },
    { name: "The Bridge", description: "Advanced position requiring flexibility where one partner creates a bridge arch.", image: "https://images.pexels.com/photos/12675574/pexels-photo-12675574.jpeg" },
    { name: "Side Straddle", description: "Creative side position combining elements of spooning with more active movement.", image: "https://images.pexels.com/photos/6899789/pexels-photo-6899789.jpeg" },
    { name: "The Chair", description: "Utilizes furniture for support and new angles of intimacy and comfort.", image: "https://images.pexels.com/photos/16251532/pexels-photo-16251532.jpeg" },
